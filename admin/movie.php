                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                                    ...
                                                    <div class="modal-dialog modal-xl">
                                                        <div class="modal-content bg-transparent">
                                                            ...
                                                            <div class="modal-body text-center">
                                                                <iframe class="embed-responsive-item" width="854" height="480" src="https://www.youtube.com/embed/<?php echo $row[3]; ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <td class="align-middle"> <a href="movie_detail.php"><span class="badge bg-light rounded-pill badge-sm">DETAILS</span></a> </td>
                                            <td class="align-middle"> <a href="movie_edit.php"><span class="badge bg-info rounded-pill badge-sm">EDIT</span></a> </td>
                                        </tr>
                                        <?php                                                    
                                                }
                                            }
